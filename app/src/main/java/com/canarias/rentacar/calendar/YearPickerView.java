...
import com.canarias.rentacar.widgets.TextViewWithCircularIndicator;
 ...
 */
public class YearPickerView extends ListView implements OnItemClickListener, CalendarDatePickerDialog.OnDateChangedListener {
    ...
    public void onDateChanged() {
        mAdapter.notifyDataSetChanged();
        postSetSelectionCentered(mController.getSelectedDay().getYear() - mController.getMinYear());
    }
    ...
    private class YearAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            boolean selected = mController.getSelectedDay().getYear() == year;
