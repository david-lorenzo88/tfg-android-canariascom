...
public abstract class MonthView extends View {
    ...
    /**
     * Called when the user clicks on a day. Handles callbacks to the {@link com.canarias.rentacar.calendar.MonthView.OnDayClickListener} if one is set.
     *
    ...
    public boolean restoreAccessibilityFocus(CalendarDay day) {
        if ((day.getYear() != mYear) || (day.getMonth() != mMonth) || (day.getDay() > mNumCells)) {
            return false;
        }
        mTouchHelper.setFocusedVirtualView(day.getDay());
        return true;
    }
