...
package com.canarias.rentacar.calendar;
...
import com.canarias.rentacar.adapters.MonthAdapter;
import com.canarias.rentacar.adapters.SimpleMonthAdapter;
 ...
 */
public abstract class DayPickerView extends ListView implements OnScrollListener, CalendarDatePickerDialog.OnDateChangedListener {
    ...
    public boolean goTo(MonthAdapter.CalendarDay day, boolean animate, boolean setSelected, boolean forceScroll) {
        ...
        mTempDay.set(day);
        final int position = (day.getYear() - mController.getMinYear())
                * SimpleMonthAdapter.MONTHS_IN_YEAR + day.getMonth();
    ...
    protected void setMonthDisplayed(MonthAdapter.CalendarDay date) {
        mCurrentMonthDisplayed = date.getMonth();
        invalidateViews();
    }
    ...
    private String getMonthAndYearString(MonthAdapter.CalendarDay day) {
        ...
        cal.set(day.getYear(), day.month, day.getDay());
